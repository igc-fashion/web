				...
				function doSelect() {
					...
					var selectbox = $(
						'<span class="selectbox" style="display:inline-block;position:relative">' +
							'<div class="select" style="float:left;position:relative;z-index:10"><div class="text">' +
							optionText +
							"</div>" +
							'<b class="trigger"><i class="arrow"></i></b>' +
							"</div>" +
							'<div class="dropdown" style="position:absolute;z-index9;overflow:auto;overflow-x:hidden;list-style:none">' +
							"<ul>" +
							ddlist +
							"</ul>" +
							"</div>" +
	...
	$.fn.menu = function (options) {
		...
		return this.each(function () {
			...
			$("a", self).on("click", function (e) {
				...
				if (href == "#") {
					// if e.targete.preventDefault();
					// 			 $(".collections-container").share({
					//     networks: ["whatsapp",'facebook', 'pinterest', 'googleplus', 'twitter','linkedin']
					// });
		// 			 $(".share-container").share({
        //     networks: ["whatsapp",'facebook', 'pinterest', 'googleplus', 'twitter','linkedin']
        // });
        var shrcn = $(".collections-container"),
            swra = $(".collections-wrapper"),
            clsh = $(".close-share-btn"),
            shic = $(".share-icon"),
            ssbtn = $(".showCollections");
        ...
        ssbtn.on("click", function() {
            ...
            if ($(".collections-container").hasClass("isShare")) showShare();
            // else hideShare();
        });
					// $(this).hide(1000)
	...
	jQuery.fn.lavaLamp = function (a) {
		...
		return this.each(function () {
			function m(e, c) {
				...
				e || (e = b);
				a.includeMargins ||
					((h = d(e.css("marginLeft"))), (k = d(e.css("marginTop"))));
				var g = {
			...
			(a.homeTop || a.homeLeft) && 1 > b.length && (b = q);
			if (1 > b.length) {
				var r = 0,
					v;
				l.each(function () {
					var a = c("a:first", this).attr("href");
					-1 < w.indexOf(a) && a.length > r && ((v = c(this)), (r = a.length));
				});
				0 < r && (b = v);
			}
			1 > b.length && (b = l.eq(0));
			...
			l.on("mouseenter focusin", function () {
				...
				a.setOnClick &&
					(b.removeClass(a.selectClass), (b = c(this).addClass(a.selectClass)));
			...
			var f = c(
				...
				.prependTo(this);
			a.includeMargins &&
				((t = d(b.css("marginTop")) + d(b.css("marginBottom"))),
				(u = d(b.css("marginLeft")) + d(b.css("marginRight"))));
			n =
				d(f.css("borderLeftWidth")) +
				d(f.css("borderRightWidth")) +
				d(f.css("paddingLeft")) +
				d(f.css("paddingRight")) -
				u;
			p =
				d(f.css("borderTopWidth")) +
				d(f.css("borderBottomWidth")) +
				d(f.css("paddingTop")) +
				d(f.css("paddingBottom")) -
				t;
			a.homeTop || a.homeLeft
				...
				: (a.includeMargins ||
						((h = d(b.css("marginLeft"))), (k = d(b.css("marginTop")))),
				  f.css({
